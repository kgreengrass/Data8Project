...
# For the interview notes bucket it take 5 min to write into the df
class ReadTransformJson:
    ...
    def json_reader(self, folder_name):
        ...
        for index, record in enumerate(self.file_names_dict[self.bucket_folder]):
            ...
            s3object = s3_client.get_object(Bucket='data8-engineering-project',
                                            Key=folder_name + '/' + record)
