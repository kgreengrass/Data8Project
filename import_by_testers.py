...
cursor.execute("SELECT @@version;")
    ...
    def __init__(self, function, insert_statement)
        export_tab()
 ...
 export_instance = ExportTable(strengths(), "INSERT INTO SpartaDB.dbo.Strengths (strength_ID, strength_name) VALUES (?,?)", row['StrengthID'], row['StrengthName'])
